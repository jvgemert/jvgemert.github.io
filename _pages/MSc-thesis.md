...
## Doing a Master thesis with me

I try to give MSc students a sense of doing real, cutting edge research and I have [published](/pub/) in top venues based on a MSc thesis.
...
- **Mare**: (For CS/DSAIT students) Sign up your MSc thesis in [MaRe](https://mare.ewi.tudelft.nl/login) (do this as soon as possible).


- **Committee form in MaRe**: For your thesis committee graduation we need at least 1 member outside of the PRB section. At our first meeting, please suggest 2 potential EWI faculty members outside PRB to be on your committee. You can find potential committee members on the "people" sections of the TUD computer science webpages, or it can be faculty members where you enjoyed their courses or have had contact with before. Note: it has to a faculty member from the computer science (INSY or ST) departments of EWI. Try to submit this form as soon as possible.

- **Brightspace**: For CS/DSAIT students, sign up for the MSc Thesis project for [CS](https://brightspace.tudelft.nl/d2l/home/492868) or for [DSAIT](https://brightspace.tudelft.nl/d2l/home/622492) in Brightspace.

- **GIT**: Please create a git project with 3 folders: 'code' (for your code), 'thesis' (for your latex files), 'notes' (for our agreements) and give me (read) access.

- **Planning**: Planning is part of your final grade and you are responsible for making sure that you graduate on time. Add a text file to the 'notes' folder on the git with the name: "planning.txt" with a planning time line (give the expected dates) of when required forms, committee meetings, milestones, green light moments, etc., are due (MaRe will have those). Note that I cannot keep track of each step for all students, so, please do not depend on me and plan this for yourself. The information can be found on Brighspace and Mare
...
- **Mattermost**:  Sign up for our [Mattermost](https://mattermost.tudelft.nl/signup_user_complete/?id=6s4mbkktnp8iixt17rqea6h8ny&md=link&sbr=su/) and join the public "`CV-lab-MSCthesis`" channel. You can use this channel to get in contact with other MSc students. Writing a thesis is individual, and can be lonely,  so please use this opportunity to meet/discuss with other students in a similar situation. Many parts of the research process are the same for each student, even if particular topics vary. Sharing these experiences with others benefits you, as well as your fellow students. Don't be shy, just say `hi`, there :blush:.
...
- **Clean**: Please regularly remove things you no longer need. How is it going with the number of (small) files? Please avoid using very many small files, as this slows down access and clogs the file system (limited nr of inodes). Consider using [HDF5](https://en.wikipedia.org/wiki/Hierarchical_Data_Format/).
...
See below for some questions that you may expect during your defense, and which thus should also be answered in your thesis and at your Green-Light moment. Please try to keep [Hitchens's razor](https://en.wikipedia.org/wiki/Hitchens%27s_razor/) in mind for each motivation and claim that you make: *`What can be asserted without evidence can also be dismissed without evidence`*. Please re-read my research [guidelines](/links.html).
...
- How can we be sure that your explanation is correct? Are you "confusing explanation with speculation" (see: [Troubling Trends in Machine Learning Scholarship](https://arxiv.org/abs/1807.03341/)). What is your evidence for this?
- How can we be sure that the improved accuracy comes from what you claim: "failure to identify the sources of empirical gains" (see: [Troubling Trends in Machine Learning Scholarship](https://arxiv.org/abs/1807.03341/). Note that improved accuracy is nice, but the scientific interest is the detailed, well-motivated, well-investigated, answer to "why does it improve?", and providing evidence for this.
- When will your approach fail? What assumptions does it make? In which cases will your approach not work, and in which cases will it work well? Do you have evidence for this? If not, what would be the steps to gather this evidence?
- Will your approach generalize to a slight different setting (eg, more realistic, different domain, different modality, etc..)? In which cases will your approach not generalize, and in which cases will it work well? Do you have evidence for this? If not, what would be the steps to gather this evidence?
...
- Why did you use this particular (analysis, statistical, training, hyper-parameter tuning, etc. ) method? Are there not other, better fitting ones? Why (not)?
- In your article you use the term XXX, but it is not explained; what does this mean?
...
- Looking forward, if we give you 1 million Euros funding to continue your work, what would you use the funding for? (be as specific as possible).
- Do you see societal value in you work? If so, what is it, and c/would you want to be able to explore this further, and how?
