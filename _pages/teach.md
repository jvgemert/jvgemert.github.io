...
You can find these reflected in my [guidelines](/links.html). 
...
<div class="row">
    <div class="col-sm-4 mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="/assets/img/mdl-logo1.png" title="Machine and Deep learning logo" class="img-fluid rounded z-depth-1" %}
    </div>
</div>

- [intro](/assets/slides/MDL-TUD-00-intro.pdf)
- [feedforward](/assets/slides/MDL-TUD-01-feedforward.pdf)
- [loss](/assets/slides/MDL-TUD-02-loss.pdf) with the excellent [notes](/assets/slides/MDL-RGrosse-loss.pdf) by [Roger Grosse](https://www.cs.toronto.edu/~rgrosse/).
- [backprop](/assets/slides/MDL-TUD-03-backprop.pdf) with the excellent [bar notation](/assets/slides/MDL-RGrosse-backprop.pdf) by [Roger Grosse](https://www.cs.toronto.edu/~rgrosse/).
- [optimization](/assets/slides/MDL-TUD-04-optimization.pdf)
- [cnn](/assets/slides/MDL-TUD-05-cnn.pdf)
- [rnn](/assets/slides/MDL-TUD-06-rnn.pdf)
- [selfAttention](/assets/slides/MDL-TUD-07-selfAttention.pdf)
- [unsupervised](/assets/slides/MDL-TUD-08-unsupervised.pdf)
- [foundationModel](/assets/slides/MDL-TUD-09-foundationModel.pdf)
